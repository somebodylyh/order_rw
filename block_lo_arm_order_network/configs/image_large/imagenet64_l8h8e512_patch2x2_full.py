"""ImageNet-64 VQ-f4 full 800k patch2x2 (8x8 block grid) random-order baseline.
...
Checkpoints saved at: 1k, 5k, 10k, 20k (iter, via save_iter_checkpoints).
"""
...
eval_iters = 200
log_interval = 10
always_save_checkpoint = False       # only save at iteration checkpoints below
save_iter_checkpoints = True
save_iter_checkpoint_steps = "1000,5000,10000,20000"
save_iter_checkpoint_keep = 0        # keep all

# ---------------------- W&B ----------------------
wandb_log = True
wandb_project = "AOGPT-order-image64-vq-f4"
wandb_run_name = "imagenet64-vqf4-800k-seq256-patch2x2-full-b16-l8h8e512"
wandb_run_id = ""
