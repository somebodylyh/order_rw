...
# Usage:
#   python scripts/runner/hierarchical_segment_curriculum_runner.py config/WikiText103/seq80/permute/block1/segment_curriculum.py

config = 'config/WikiText103/seq80/permute/block1/random.py'

train_out_dir = 'out/curriculum/permute/seq80/block1/out-wikitext103-seq80-random-b1-hcurr'
benchmark_root = 'Report/curriculum/permute/seq80/block1/hierarchical_block1'

wandb_project = 'AOGPT-order-block-seq80'
wandb_run_name = 'seq80-random-b1-permute-hcurr-margin'
