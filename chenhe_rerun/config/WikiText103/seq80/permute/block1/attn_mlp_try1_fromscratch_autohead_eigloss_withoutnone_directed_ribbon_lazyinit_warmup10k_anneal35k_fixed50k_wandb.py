# WikiText103 seq80 permuted block1 try_1:
...
out_dir = 'out/base/permute/seq80/block1/out-wikitext103-seq80-try1-autohead-eigloss-withoutnone-directed-ribbon-lazyinit-warmup10k-anneal35k-fixed50k-b1-permute'
...
wandb_run_name = 'seq80-try1-autohead-eigloss-withoutnone-directed-ribbon-lazyinit-warmup10k-anneal35k-fixed50k-b1-permute'
...
attn_mlp_policy_log_input_attn_prefix = 'seq80_try1_autohead_eigloss_withoutnone_input_attn'
attn_mlp_policy_log_input_attn_out_dir = 'Report/MLP_loss_training/seq80_try_1/input_attn'
...
head_asym_selector_out_dir = 'Report/MLP_loss_training/seq80_try_1/head_asym_selector'
