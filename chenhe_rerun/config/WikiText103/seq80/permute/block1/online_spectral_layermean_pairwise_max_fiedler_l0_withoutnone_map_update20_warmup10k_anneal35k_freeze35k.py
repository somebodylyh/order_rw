...
#
# Method:
# - inherit the seq80 permuted random-base training shape;
...
# - 10000..35000: every 20 steps, update priority_ema from L0 layer mean.
...
out_dir = 'out/base/permute/seq80/block1/out-wikitext103-seq80-online-spectral-layermean-pairwise-max-fiedler-l0-withoutnone-map-update20-warmup10k-anneal35k-freeze35k-b1-permute-50000-iters'

wandb_log = True
wandb_project = 'AOGPT-order-block-seq80-final'
wandb_run_name = 'seq80-online-spectral-layermean-pairwise-max-fiedler-l0-withoutnone-map-update20-warmup10k-anneal35k-freeze35k-b1-permute-50000-iters'
...
head_signal_probe_out_dir = 'Report/language/wikitext103/order_teacher_distribution/head_signal_stability/distribution_training_tries/seq80_layermean_pairwise_max_fiedler_l0_withoutnone_map_update20_warmup10k_anneal35k_freeze35k_permute/online_training_probe'

# Keep the seq80 online-probe budget aligned with the existing seq80
# distribution configs: 16 x 256 = 4096 attention samples.
...
online_spectral_policy_log_input_attn_prefix = 'seq80_layermean_pairwise_max_fiedler_l0_distribution_input_attn'
online_spectral_policy_log_input_attn_out_dir = 'Report/language/wikitext103/order_teacher_distribution/head_signal_stability/distribution_training_tries/seq80_layermean_pairwise_max_fiedler_l0_withoutnone_map_update20_warmup10k_anneal35k_freeze35k_permute/input_attn'
