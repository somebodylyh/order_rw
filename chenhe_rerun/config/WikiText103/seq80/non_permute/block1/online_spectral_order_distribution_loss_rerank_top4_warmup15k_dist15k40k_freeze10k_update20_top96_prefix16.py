...
# Schedule:
# - 0..15000: pure random warmup, no online probe/rerank updates
# - 15000..40000: update every 20 steps and train from the learned distribution
...
out_dir = 'out/base/nonpermute/seq80/block1/out-wikitext103-seq80-online-spectral-order-distribution-loss-rerank-top4-warmup15k-dist15k40k-freeze10k-update20-top96-prefix16-kall-lowtemp-no-random-mix-b1-nonpermute-50000-iters'
wandb_run_name = 'seq80-online-spectral-order-distribution-loss-rerank-top4-warmup15k-dist15k40k-freeze10k-update20-top96-prefix16-kall-lowtemp-no-random-mix-b1-nonpermute-50000-iters'
compile = False
eval_batch_size = 64

# First recovery happens at iter 15000. The training batch at iter 15000 still
# uses random because the distribution is created after the probe/update.
online_spectral_policy_update_start_iter = 15000
online_spectral_policy_anneal_start_iter = 15000
online_spectral_policy_anneal_end_iter = 15001
...
# Distribution mode keeps a small local ensemble of the best reranked directions.
