# WikiText103 seq80 / non-permute / block1 token-level distribution config.
#
# Method:
# - inherit the seq80 non-permuted random-base training shape;
...
_base_config = 'config/WikiText103/seq80/non_permute/block1/random.py'
with open(_base_config, 'r', encoding='utf-8') as _handle:
    exec(_handle.read())

out_dir = 'out/base/nonpermute/seq80/block1/out-wikitext103-seq80-online-spectral-layermean-pairwise-max-fiedler-l0-withoutnone-map-update20-warmup20k-anneal35k-freeze35k-b1-nonpermute-50000-iters'

wandb_log = True
wandb_project = 'AOGPT-order-block-seq80-final'
wandb_run_name = 'seq80-online-spectral-layermean-pairwise-max-fiedler-l0-withoutnone-map-update20-warmup20k-anneal35k-freeze35k-b1-nonpermute-50000-iters'
...
head_signal_probe_out_dir = 'Report/language/wikitext103/order_teacher_distribution/head_signal_stability/distribution_training_tries/seq80_layermean_pairwise_max_fiedler_l0_withoutnone_map_update20_warmup20k_anneal35k_freeze35k_nonpermute/online_training_probe'
...
online_spectral_policy_log_input_attn_prefix = 'seq80_nonpermute_layermean_pairwise_max_fiedler_l0_distribution_input_attn'
online_spectral_policy_log_input_attn_out_dir = 'Report/language/wikitext103/order_teacher_distribution/head_signal_stability/distribution_training_tries/seq80_layermean_pairwise_max_fiedler_l0_withoutnone_map_update20_warmup20k_anneal35k_freeze35k_nonpermute/input_attn'
