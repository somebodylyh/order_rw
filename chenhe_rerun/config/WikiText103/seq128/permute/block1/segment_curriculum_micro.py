...
# Usage:
#   python scripts/runner/hierarchical_segment_curriculum_runner.py config/WikiText103/seq128/permute/block1/segment_curriculum_micro.py

config = 'config/WikiText103/seq128/permute/block1/random.py'

train_out_dir = 'out/curriculum/permute/seq128/block1/out-wikitext103-seq128-random-b1-hcurr-micro'
benchmark_root = 'Report/curriculum/permute/seq128/block1/hierarchical_block1_micro'

wandb_project = 'AOGPT-order-block-seq128'
wandb_run_name = 'seq128-random-b1-permute-hcurr-token-micro'
