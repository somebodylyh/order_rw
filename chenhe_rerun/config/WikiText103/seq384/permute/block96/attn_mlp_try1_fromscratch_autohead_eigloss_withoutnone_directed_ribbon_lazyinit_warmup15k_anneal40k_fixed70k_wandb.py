# WikiText103 seq384 permuted block96 try_1:
# Seq384 port of the latest no-prior Attn-MLP method.
#
# Base training shape is inherited from seq384/permute/block96/random.py:
# - block_size=384, block_order_block_len=4, num_blocks=96
# - batch_size=32, gradient_accumulation_steps=2
# - eval_batch_size=16 keeps eval from fragmenting the training memory pool.
# - permute_data=True, permute_seed=42, permute_mode='block'
# - model/lr/max_iters/eval cadence follow the seq256 language base style.
#
# Schedule:
# - 0..15k: pure Random warmup. The Attn-MLP policy is lazy-initialized, so
#   MLP parameters and optimizer are not created before the selector fires.
# - iter 15k: select one head from current-frame without_none attention:
...
# - 15k..40k: train the MLP/order with directed-ribbon loss.
...
_base_config = 'config/WikiText103/seq384/permute/block96/random.py'
with open(_base_config, 'r', encoding='utf-8') as _handle:
    exec(_handle.read())

out_dir = 'out/base/permute/seq384/block96/out-wikitext103-seq384-try1-autohead-eigloss-withoutnone-directed-ribbon-lazyinit-warmup15k-anneal40k-fixed70k-b96-permute-block'
...
wandb_run_name = 'seq384-try1-autohead-eigloss-withoutnone-directed-ribbon-lazyinit-warmup15k-anneal40k-fixed70k-b96-permute'
...
attn_mlp_policy_lazy_init_iter = 15000
...
attn_mlp_policy_start_iter = 15000
attn_mlp_policy_start_prob = 0.0
attn_mlp_policy_end_prob = 1.0
attn_mlp_policy_anneal_start_iter = 15000
...
attn_mlp_policy_log_input_attn_prefix = 'seq384_block96_try1_autohead_eigloss_withoutnone_input_attn'
attn_mlp_policy_log_input_attn_out_dir = 'Report/MLP_loss_training/seq384_block96_try_1/input_attn'
...
attn_mlp_policy_directed_ribbon_band_width = 12.0
...
attn_mlp_policy_lr_anneal_start_iter = 15000
...
head_asym_selector_target_iter = 15000
...
head_asym_selector_out_dir = 'Report/MLP_loss_training/seq384_block96_try_1/head_asym_selector'
...
head_asym_selector_loss_prefix_k = 24
head_asym_selector_loss_score = 'linear_profile'
head_asym_selector_loss_exp_tau = 24.0
