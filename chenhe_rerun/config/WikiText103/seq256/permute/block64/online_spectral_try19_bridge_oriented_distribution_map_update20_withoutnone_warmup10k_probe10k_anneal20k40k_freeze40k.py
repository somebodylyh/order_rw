# Try19 ablation: without-none attention export, oriented EMA MAP distribution.
#
# This is paired with the with-none config of the same schedule. The only
# intended methodological difference is head_signal_probe_export_type:
# without_none uses attention[:, :, 1:, 1:] instead of attention[:, :, :-1, :-1].
#
# Schedule:
...
out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-online-spectral-try19-bridge-oriented-distribution-map-update20-withoutnone-warmup10k-probe10k-anneal20k40k-freeze40k-b64-permute-block-50000-iters'

wandb_log = True
wandb_project = 'AOGPT-order-block-64-final'
wandb_run_name = 'seq256-online-spectral-try19-bridge-oriented-distribution-map-update20-withoutnone-warmup10k-probe10k-anneal20k40k-freeze40k-b64-permute-50000-iters'
...
head_signal_probe_out_dir = 'Report/head_singal_Stable/try19_bridge_oriented_distribution_map_update20_withoutnone_warmup10k_probe10k_anneal20k40k_freeze40k_permute/online_training_probe'
