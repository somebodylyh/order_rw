# Temperature-sampling order-usage ablation for the latest L0 layer-level
# distribution teacher.
#
# Difference from the probability-anneal base:
# - 0..15000: random order, no priority_ema updates.
# - 15000..35000: update priority_ema every 20 steps and train with
#   Gumbel-top-k samples from the learned priority score.
# - temperature linearly decreases from 2.0 to 0.1 during this sampling window.
# - 35000..50000: stop EMA updates and train deterministic MAP order.
#
# Teacher construction, current-model loss-profile orientation, permutation
# rules, block-internal L2R, and evaluation logic are inherited unchanged.
...
out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-online-spectral-layermean-pairwise-max-fiedler-l0-withoutnone-temp-sampling-t2to01-update20-warmup15k-sample35k-freeze35k-seed2027-sameperm-b64-permute-block-50000-iters'

wandb_log = True
wandb_project = 'AOGPT-order-block-64-final'
wandb_run_name = 'seq256-online-spectral-layermean-pairwise-max-fiedler-l0-withoutnone-temp-sampling-t2to01-update20-warmup15k-sample35k-freeze35k-seed2027-sameperm-b64-permute-50000-iters'
...
_report_root = 'Report/language/wikitext103/order_teacher_distribution/head_signal_stability/distribution_training_tries/temperature_sampling_l0_pairwise_max_fiedler_withoutnone_t2to01_update20_warmup15k_sample35k_freeze35k_seed2027_sameperm'
...
online_spectral_policy_log_input_attn_prefix = 'temperature_sampling_l0_pairwise_max_fiedler_seed2027_distribution_input_attn'
