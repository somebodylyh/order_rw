# WikiText103 seq256 permuted block64 config for the one-step lagged
# fixed-head online attention-spectral teacher policy.
#
# Orders are always current-frame block ids. The fixed data permutation is only
# used by train.py for data loading and checkpoint diagnostics.

out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-online-spectral-fixed-head-b64-permute-block-50000-iters'
eval_interval = 250
eval_iters = 200
log_interval = 10
...
wandb_run_name = 'seq256-online-spectral-fixed-head-b64-permute-50000-iters'
