# WikiText103 seq256 permuted block64 try_49:
# Paired seed with try_47, but maintain an EMA over the MLP continuous scores.
...
out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try49-seed2030-fromscratch-frozen-try33-score-mlp-scoreema095-update1-warmup15k-anneal35k-freeze35k-b64-permute-block'
...
wandb_run_name = 'seq256-try49-seed2030-fromscratch-frozen-try33-score-mlp-scoreema095-update1-warmup15k-anneal35k-freeze35k-b64-permute'
...
attn_mlp_policy_log_input_attn_prefix = 'try49_seed2030_fromscratch_frozen_try33_score_mlp_scoreema095_update1_input_attn'
attn_mlp_policy_log_input_attn_out_dir = 'Report/language/wikitext103/mlp/distillation/try_49/input_attn'
