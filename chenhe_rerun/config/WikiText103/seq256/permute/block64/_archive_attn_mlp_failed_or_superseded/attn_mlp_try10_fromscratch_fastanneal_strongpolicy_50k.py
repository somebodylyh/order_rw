# WikiText103 seq256 permuted block64 try_10:
# from-scratch backbone + from-scratch trainable Attn-MLP.
#
# try_10 keeps try_9's best 50k schedule and strengthens only the no-prior
# policy-learning signal. OriginalL2R, original tau, oracle permutations, and
# hand-written original-order labels are not used for training, reranking,
# early stopping, or model selection. Tau is diagnostic only.

out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try10-fromscratch-fastanneal-strongpolicy-50k-b64-permute-block'
eval_interval = 1000
eval_iters = 200
log_interval = 10
...
wandb_run_name = 'seq256-try10-fromscratch-fastanneal-strongpolicy-50k-b64-permute'
...
attn_mlp_policy_move_pref_weight = 6.0
