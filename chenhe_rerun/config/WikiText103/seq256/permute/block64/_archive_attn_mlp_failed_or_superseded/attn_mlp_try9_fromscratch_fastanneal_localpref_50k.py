# WikiText103 seq256 permuted block64 try_9:
# from-scratch backbone + from-scratch trainable Attn-MLP.
#
# try_9 is PPL-oriented. It keeps the strongest no-prior loss family from
# try_7, removes try_8's global proposal preference, and spends less of the
# 50k budget in pure random training. OriginalL2R, original tau, oracle
# permutations, and hand-written original-order labels are not used for
# training, reranking, early stopping, or model selection. Tau is diagnostic.

out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try9-fromscratch-fastanneal-localpref-50k-b64-permute-block'
eval_interval = 1000
eval_iters = 200
log_interval = 10
...
wandb_run_name = 'seq256-try9-fromscratch-fastanneal-localpref-50k-b64-permute'
...
# Faster handoff than try_7:
# 0-5k random, 5k-20k anneal, 20k-35k 100% MLP and trainable,
# 35k-50k fixed cached order.
