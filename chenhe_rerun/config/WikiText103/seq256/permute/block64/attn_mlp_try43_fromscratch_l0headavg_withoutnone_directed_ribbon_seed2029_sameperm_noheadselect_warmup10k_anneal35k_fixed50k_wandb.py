# try43: same trainable Attn-MLP recipe as try42, but changes the attention
# source from layer-1 head-average to layer-0 head-average:
# use_global=False, layer=0, head=-1.
#
...
out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try43-seed2029-sameperm-l0headavg-withoutnone-directed-ribbon-noheadselect-warmup10k-anneal35k-fixed50k-b64-permute-block'
wandb_run_name = 'seq256-try43-seed2029-sameperm-l0headavg-withoutnone-directed-ribbon-noheadselect-warmup10k-anneal35k-fixed50k-b64-permute'

# No selector: use the average of all heads in layer 0.
...
head_asym_selector_out_dir = 'Report/MLP_loss_training/try_43/head_asym_selector_disabled'
...
attn_mlp_policy_log_input_attn_prefix = 'try43_seed2029_l0headavg_withoutnone_input_attn'
attn_mlp_policy_log_input_attn_out_dir = 'Report/MLP_loss_training/try_43/input_attn'
