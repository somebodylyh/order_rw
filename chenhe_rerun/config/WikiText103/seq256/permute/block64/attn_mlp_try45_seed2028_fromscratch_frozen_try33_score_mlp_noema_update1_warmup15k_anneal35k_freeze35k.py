# WikiText103 seq256 permuted block64 try_45:
# Seed ablation of try_44 with seed=2028. All method settings match try_44.
...
out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try45-seed2028-fromscratch-frozen-try33-score-mlp-noema-update1-warmup15k-anneal35k-freeze35k-b64-permute-block'
...
wandb_run_name = 'seq256-try45-seed2028-fromscratch-frozen-try33-score-mlp-noema-update1-warmup15k-anneal35k-freeze35k-b64-permute'
...
attn_mlp_policy_log_input_attn_prefix = 'try45_seed2028_fromscratch_frozen_try33_score_mlp_noema_update1_input_attn'
attn_mlp_policy_log_input_attn_out_dir = 'Report/language/wikitext103/mlp/distillation/try_45/input_attn'
