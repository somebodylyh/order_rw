# WikiText103 seq256 permuted block64 try_54:
# Shadow-train a random-init score MLP from 8k to 10k. Each optimizer step uses
# 15 raw samples for train and 3 raw samples for val, yielding 30k train and 6k
# val raw samples over the 2000-step shadow window. Other score-MLP settings
# follow try53.
...
out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try54-seed2027-shadow-teacher-score-mse-train8k10k-step15val3-policyattn1024-fixed10k-anneal10k35k-b64-permute-block'
...
wandb_run_name = 'seq256-try54-seed2027-shadow-teacher-score-mse-train8k10k-step15val3-policyattn1024-fixed10k-anneal10k35k-b64-permute'
...
# 8k..10k: Random backbone, shadow-train MLP from current attention.
#           Each optimizer step uses 15 train raw samples and 3 val raw samples.
# 10k..35k: stop MLP optimizer updates, anneal Random -> fixed-parameter MLP.
#           Order refresh still buffers eight optimizer steps per policy attn.
...
attn_mlp_policy_shadow_mse_train_samples_per_step = 15
attn_mlp_policy_shadow_mse_val_samples_per_step = 3
...
attn_mlp_policy_shadow_mse_log_path = 'Report/language/wikitext103/mlp/distillation/try_54/input_attn/attn_mlp_shadow_mse_history.jsonl'
...
attn_mlp_policy_log_input_attn_prefix = 'try54_seed2027_shadow_teacher_score_mse_train8k10k_step15val3_fixed10k_input_attn'
attn_mlp_policy_log_input_attn_out_dir = 'Report/language/wikitext103/mlp/distillation/try_54/input_attn'
