...
# From-scratch seed ablation of the frozen try_25 distilled Attn-MLP backbone
# integration. This run does not copy or resume from the clean Random 10k
# checkpoint.
#
# Schedule:
# - 0..10k: Random warmup inside this run.
# - 10k..35k: refresh frozen MLP order every 20 steps and anneal Random -> MLP.
...
out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try27-seed2028-fromscratch-frozen-try25-l0-layermean-fiedler-mlp-warmup10k-anneal35k-freeze35k-b64-permute-block'
...
wandb_run_name = 'seq256-try27-seed2028-fromscratch-frozen-try25-l0-layermean-fiedler-mlp-warmup10k-anneal35k-freeze35k-b64-permute'
...
# L0 all-head mean, matching try_26 and the latest pairwise-max Fiedler line.
...
attn_mlp_policy_log_input_attn_prefix = 'try27_seed2028_fromscratch_frozen_try25_l0_layermean_fiedler_mlp_input_attn'
attn_mlp_policy_log_input_attn_out_dir = 'Report/language/wikitext103/mlp/distillation/try_27/input_attn'
