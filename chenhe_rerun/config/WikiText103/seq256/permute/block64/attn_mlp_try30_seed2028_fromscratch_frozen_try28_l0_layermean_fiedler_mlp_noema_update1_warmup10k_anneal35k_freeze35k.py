...
# Seed ablation of try_29 with seed=2028. This is the same from-scratch frozen
# try_28 MLP integration, no attention EMA, and every-step MLP order refresh.
...
out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try30-seed2028-fromscratch-frozen-try28-l0-layermean-fiedler-mlp-noema-update1-warmup10k-anneal35k-freeze35k-b64-permute-block'
...
wandb_run_name = 'seq256-try30-seed2028-fromscratch-frozen-try28-l0-layermean-fiedler-mlp-noema-update1-warmup10k-anneal35k-freeze35k-b64-permute'
...
attn_mlp_policy_log_input_attn_prefix = 'try30_seed2028_fromscratch_frozen_try28_l0_layermean_fiedler_mlp_noema_update1_input_attn'
attn_mlp_policy_log_input_attn_out_dir = 'Report/language/wikitext103/mlp/distillation/try_30/input_attn'
