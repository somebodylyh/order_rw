...
# Usage:
#   python scripts/runner/hierarchical_segment_curriculum_runner.py config/WikiText103/seq256/permute/block64/segment_curriculum_early_stop_open_level_rope.py
#
# RoPE ablation of segment_curriculum_early_stop_open_level.py. This keeps the
# current best block64 gain-only curriculum parameters, but trains the backbone
# with `position_encoding_mode='rope'`.

config = 'config/WikiText103/seq256/permute/block64/random_rope.py'

train_out_dir = 'out/curriculum/permute/seq256/block64/out-wikitext103-seq256-random-b64-permute-hcurr-early-stop-open-level-gain-only-rope-6-stage'
benchmark_root = 'Report/curriculum/permute/seq256/block64/hierarchical_block64_early_stop_open_level_gain_only_rope-6-stage'

wandb_project = 'AOGPT-order-block-64-rope'
wandb_run_name = 'seq256-random-b64-permute-hcurr-early-stop-open-level-gain-only-rope-6-stage'
