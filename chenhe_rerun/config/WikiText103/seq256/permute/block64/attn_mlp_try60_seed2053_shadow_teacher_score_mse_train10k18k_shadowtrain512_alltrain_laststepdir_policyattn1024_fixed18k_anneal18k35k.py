# WikiText103 seq256 permuted block64 try_60:
# Same as try57, but with seed=2053. Shadow-train a random-init score MLP from
...
out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try60-seed2053-shadow-teacher-score-mse-train10k18k-shadowtrain512-alltrain-laststepdir-policyattn1024-linearlabel-stop32k-prob08-freeze35k-b64-permute-block'
...
wandb_run_name = 'seq256-try60-seed2053-shadow-teacher-score-mse-train10k18k-shadowtrain512-alltrain-laststepdir-policyattn1024-linearlabel-stop32k-prob08-freeze35k-b64-permute'
...
attn_mlp_policy_shadow_mse_log_path = 'Report/language/wikitext103/mlp/distillation/try_60/input_attn/attn_mlp_shadow_mse_history.jsonl'
...
attn_mlp_policy_log_input_attn_prefix = 'try60_seed2053_shadow_teacher_score_mse_train10k18k_shadowtrain512_alltrain_laststepdir_linearlabel_stop32k_prob08_freeze35k_input_attn'
attn_mlp_policy_log_input_attn_out_dir = 'Report/language/wikitext103/mlp/distillation/try_60/input_attn'
