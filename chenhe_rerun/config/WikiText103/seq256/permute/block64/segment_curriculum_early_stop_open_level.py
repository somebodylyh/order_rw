...
# Usage:
#   python scripts/runner/hierarchical_segment_curriculum_runner.py config/WikiText103/seq256/permute/block64/segment_curriculum_early_stop_open_level.py
#
# Motivation:
#   Open-level variant of segment_curriculum_early_stop_general.py.
#   Everything is kept aligned with the gain-only early-stop block64 config
#   except names and benchmark_num_levels. For block64, benchmark_num_levels=64
#   is effectively "keep aggregating while it is still valid": early-stop treats
#   --num_levels as a maximum and stops on no_pairs_after_margin,
#   no_aggregated_segments, no_unit_count_decrease, or failed gain filtering.
...
train_out_dir = 'out/curriculum/permute/seq256/block64/out-wikitext103-seq256-random-b64-permute-hcurr-early-stop-open-level-gain-only-6-stage'
benchmark_root = 'Report/curriculum/permute/seq256/block64/hierarchical_block64_early_stop_open_level_gain_only-6-stage'

wandb_project = 'AOGPT-order-block-64-final'
wandb_run_name = 'seq256-random-b64-permute-hcurr-early-stop-open-level-gain-only-6-stage'
