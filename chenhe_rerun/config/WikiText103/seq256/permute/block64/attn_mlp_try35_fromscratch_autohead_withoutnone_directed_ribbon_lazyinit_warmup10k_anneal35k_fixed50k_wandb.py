# WikiText103 seq256 permuted block64 try_35:
# Full trainable Attn-MLP run with no hand-picked head.
#
# Schedule:
...
# - iter 10k: select one head by current-frame without_none attention asymmetry:
#     asym_score_h = sum_{i!=j} |A_ij - A_ji| / sum_{i!=j} |A_ij|
# - 10k..35k: train the MLP with directed-ribbon loss using the selected head.
...
out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try35-fromscratch-autohead-withoutnone-directed-ribbon-lazyinit-warmup10k-anneal35k-fixed50k-b64-permute-block'
...
wandb_run_name = 'seq256-try35-fromscratch-autohead-withoutnone-directed-ribbon-lazyinit-warmup10k-anneal35k-fixed50k-b64-permute'
...
attn_mlp_policy_log_input_attn_prefix = 'try35_autohead_withoutnone_input_attn'
attn_mlp_policy_log_input_attn_out_dir = 'Report/MLP_loss_training/try_35/input_attn'
...
head_asym_selector_out_dir = 'Report/MLP_loss_training/try_35/head_asym_selector'
