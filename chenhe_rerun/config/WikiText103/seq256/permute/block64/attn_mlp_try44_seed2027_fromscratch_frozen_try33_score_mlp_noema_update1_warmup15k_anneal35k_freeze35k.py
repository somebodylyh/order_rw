# WikiText103 seq256 permuted block64 try_44:
# Frozen score-distilled Attn-MLP integration using distillation try_33.
# The MLP maps current L0 all-head-mean attention to continuous Fiedler scores;
# larger score/logit reveals earlier under argsort_desc.
#
# Schedule:
# - 0..15k: Random warmup.
# - 15k..35k: Random -> frozen MLP order annealing.
# - 35k..50k: fixed cached MLP-derived order.
...
out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try44-seed2027-fromscratch-frozen-try33-score-mlp-noema-update1-warmup15k-anneal35k-freeze35k-b64-permute-block'
...
wandb_run_name = 'seq256-try44-seed2027-fromscratch-frozen-try33-score-mlp-noema-update1-warmup15k-anneal35k-freeze35k-b64-permute'
...
attn_mlp_policy_log_input_attn_prefix = 'try44_seed2027_fromscratch_frozen_try33_score_mlp_noema_update1_input_attn'
attn_mlp_policy_log_input_attn_out_dir = 'Report/language/wikitext103/mlp/distillation/try_44/input_attn'
