# WikiText103 seq256 permuted block64 try_4:
...
# reward plus local move-preference loss from current-model swap comparisons.
# No OriginalL2R/tau/L2R/permutation oracle is used for training, rerank, early
# stop, or selection.

out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try4-fromscratch-sampled-nll-pg-move-pref-warmup10k-anneal50k-update70k-fixed30k-b64-permute-block'
eval_interval = 1000
eval_iters = 200
log_interval = 10
...
wandb_run_name = 'seq256-try4-fromscratch-sampled-nll-pg-move-pref-warmup10k-anneal50k-update70k-fixed30k-b64-permute'
