# WikiText103 seq256 permuted block64 try_55:
# Same as try53, but with a new seed. Shadow MSE trains a random-init score MLP
# from 8k to 12k; each attention matrix is aggregated from 1024 raw samples and
# each MLP update uses fifteen train items plus three held-out val items.
...
out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try55-seed2027-shadow-teacher-score-mse-train8k12k-attn1024-train15val3-fixed12k-anneal12k35k-b64-permute-block'
...
wandb_run_name = 'seq256-try55-seed2027-shadow-teacher-score-mse-train8k12k-attn1024-train15val3-fixed12k-anneal12k35k-b64-permute'
...
attn_mlp_policy_shadow_mse_log_path = 'Report/language/wikitext103/mlp/distillation/try_55/input_attn/attn_mlp_shadow_mse_history.jsonl'
...
attn_mlp_policy_log_input_attn_prefix = 'try55_seed2027_shadow_teacher_score_mse_train8k12k_attn1024_train15val3_fixed12k_input_attn'
attn_mlp_policy_log_input_attn_out_dir = 'Report/language/wikitext103/mlp/distillation/try_55/input_attn'
