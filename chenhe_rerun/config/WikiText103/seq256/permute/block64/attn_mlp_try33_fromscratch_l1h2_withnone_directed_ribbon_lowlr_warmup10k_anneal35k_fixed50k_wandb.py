# WikiText103 seq256 permuted block64 try_33:
# Same from-scratch directed-ribbon Attn-MLP setup as try32, but switch the
# single-head attention export from L1H2 without_none to L1H2 with_none.
#
# No-prior rule:
...
out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try33-fromscratch-l1h2-withnone-directed-ribbon-lowlr-warmup10k-anneal35k-fixed50k-b64-permute-block'
...
wandb_run_name = 'seq256-try33-fromscratch-l1h2-withnone-directed-ribbon-lowlr-warmup10k-anneal35k-fixed50k-b64-permute'
...
# Controlled change relative to try32: without_none -> with_none.
...
attn_mlp_policy_log_input_attn_prefix = 'try33_l1h2_withnone_input_attn'
attn_mlp_policy_log_input_attn_out_dir = 'Report/MLP_loss_training/try_33/input_attn'
