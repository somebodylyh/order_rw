...
# From-scratch frozen try_28 MLP integration with the older attention-EMA input
# path restored for this ablation. The order is refreshed every step, but the
# MLP consumes an EMA of L0 layer-mean attention.
#
# Schedule:
# - 0..20k: Random warmup.
# - 20k..35k: every-step attention collection, attention EMA -> MLP order,
...
out_dir = 'out/base/permute/seq256/block64/out-wikitext103-seq256-try31-seed2027-fromscratch-frozen-try28-l0-layermean-fiedler-mlp-attnema095-update1-warmup20k-anneal35k-freeze35k-b64-permute-block'
...
wandb_run_name = 'seq256-try31-seed2027-fromscratch-frozen-try28-l0-layermean-fiedler-mlp-attnema095-update1-warmup20k-anneal35k-freeze35k-b64-permute'
...
attn_mlp_policy_log_input_attn_prefix = 'try31_seed2027_frozen_try28_l0_layermean_fiedler_mlp_attnema095_update1_input_attn'
attn_mlp_policy_log_input_attn_out_dir = 'Report/language/wikitext103/mlp/distillation/try_31/input_attn'
