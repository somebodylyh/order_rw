...
# Usage:
#   python scripts/runner/hierarchical_segment_curriculum_runner.py config/WikiText103/seq256/permute/block32/segment_curriculum.py

config = 'config/WikiText103/seq256/permute/block32/random.py'

train_out_dir = 'out/curriculum/permute/seq256/block32/out-wikitext103-seq256-random-b32-permute-hcurr-margin-aligned-eval-6-stage'
benchmark_root = 'Report/curriculum/permute/seq256/block32/hierarchical_block32_margin_aligned_eval-6-stage'

wandb_project = 'AOGPT-order-block-32-final'
wandb_run_name = 'seq256-random-b32-permute-hcurr-margin-6-stage'
