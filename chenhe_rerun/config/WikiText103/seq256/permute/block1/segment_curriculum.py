...
# Usage:
#   python scripts/runner/hierarchical_segment_curriculum_runner.py config/WikiText103/seq256/permute/block1/segment_curriculum.py

config = 'config/WikiText103/seq256/permute/block1/random.py'

train_out_dir = 'out/curriculum/permute/seq256/block1/out-wikitext103-seq256-random-b1-permute-hcurr-margin-aligned-eval'
benchmark_root = 'Report/curriculum/permute/seq256/block1/hierarchical_block1_margin_aligned_eval'

wandb_project = 'AOGPT-order-block'
wandb_run_name = 'seq256-random-b1-permute-hcurr-margin-对齐loss'
