...
# heads with geometry sign synchronization plus one global current-loss anchor.

out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-random-b64-head-signal-stable-try5-sync-global-loss-5k-to5600'
eval_interval = 200
eval_iters = 100
log_interval = 20
...
wandb_run_name = 'seq256-random-b64-head-signal-stable-try5-sync-global-loss-5k-to5600'
...
head_signal_probe_out_dir = 'Report/head_singal_Stable/try_5/online_training_probe'
...
head_signal_probe_orientation_rule = 'sync_global_loss'
