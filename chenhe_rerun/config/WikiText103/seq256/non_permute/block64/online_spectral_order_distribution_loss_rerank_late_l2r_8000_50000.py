...
# distribution with current-frame loss reranking, followed by late curriculum
# annealing from the sampled priority distribution to L2R.
#
# Schedule:
#   0..8000: random fallback -> online spectral order distribution
#   8000..50000: online spectral order distribution -> L2R

out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-online-spectral-order-distribution-loss-rerank-late-l2r-8000-50000-b64-nonpermute-50000-iters'
eval_interval = 250
eval_iters = 200
log_interval = 10
...
wandb_run_name = 'seq256-online-spectral-order-distribution-loss-rerank-late-l2r-8000-50000-b64-nonpermute-50000-iters'
