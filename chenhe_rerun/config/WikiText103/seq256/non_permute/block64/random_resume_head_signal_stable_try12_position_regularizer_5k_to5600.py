# Continue from the same 5k checkpoint and train with a no-prior position
# precedence regularizer to stabilize head orientation during training.

out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-random-b64-head-signal-stable-try12-position-regularizer-5k-to5600'
eval_interval = 200
eval_iters = 100
log_interval = 20
...
wandb_run_name = 'seq256-random-b64-head-signal-stable-try12-position-regularizer-5k-to5600'
...
head_signal_position_regularizer_enabled = True
head_signal_position_regularizer_weight = 0.1
head_signal_position_regularizer_start_iter = 5000
head_signal_position_regularizer_interval = 1
head_signal_position_regularizer_batch_size = 16
head_signal_position_regularizer_heads = 'all'
head_signal_position_regularizer_source = 'wtpe_pc1'
head_signal_position_regularizer_export_type = 'with_none'
head_signal_position_regularizer_eps = 1e-6

head_signal_probe_enabled = True
head_signal_probe_interval = 20
head_signal_probe_out_dir = 'Report/head_singal_Stable/try_12/online_training_probe'
...
head_signal_probe_position_anchor_enabled = True
head_signal_probe_position_anchor_source = 'wtpe_pc1'
head_signal_probe_position_consensus_enabled = True
