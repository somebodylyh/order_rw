# Faster-batch, lighter-rerank variant with short random warmup and short anneal.
#
# Schedule:
# - 0..5000: pure random training orders, no online probe/rerank updates
# - 5000..10000: linearly anneal policy usage from 0 to 1
# - 10000..40000: train from learned distribution, still updating online
...
out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-online-spectral-order-distribution-loss-rerank-fast-b256-update10-start5k-top32-loss1024-warmup5k-anneal10k-no-random-mix-freeze40k-map-b64-nonpermute-50000-iters'
wandb_run_name = 'seq256-online-spectral-order-distribution-loss-rerank-fast-b256-update10-start5k-top32-loss1024-warmup5k-anneal10k-no-random-mix-freeze40k-map-b64-nonpermute-50000-iters'
compile = False
