# Continue from the same 5k checkpoint with a 10x lower LR while probing all
# heads. This tests whether online sign flips are caused by fast parameter
# drift under the standard resume LR.

out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-random-b64-head-signal-stable-try6-low-lr-all-heads-5k-to5600'
eval_interval = 200
eval_iters = 100
log_interval = 20
...
wandb_run_name = 'seq256-random-b64-head-signal-stable-try6-low-lr-all-heads-5k-to5600'
...
head_signal_probe_out_dir = 'Report/head_singal_Stable/try_6/online_training_probe'
