# Continue from the same 5k checkpoint with the try-7 low-LR online probe, but
# add a no-prior training-side attention-precedence consistency regularizer.

out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-random-b64-head-signal-stable-try8-precedence-consistency-5k-to5600'
eval_interval = 200
eval_iters = 100
log_interval = 20
...
wandb_run_name = 'seq256-random-b64-head-signal-stable-try8-precedence-consistency-5k-to5600'
...
head_signal_consistency_enabled = True
head_signal_consistency_weight = 0.05
head_signal_consistency_start_iter = 5000
head_signal_consistency_interval = 1
head_signal_consistency_batch_size = 16
head_signal_consistency_heads = 'all'
head_signal_consistency_export_type = 'with_none'
head_signal_consistency_detach_target = True
head_signal_consistency_eps = 1e-6

head_signal_probe_enabled = True
head_signal_probe_interval = 20
head_signal_probe_out_dir = 'Report/head_singal_Stable/try_8/online_training_probe'
