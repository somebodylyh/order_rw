...
# distribution training. All policy orders and priorities are current-frame
# block ids; original-frame mappings are diagnostics only.

out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-online-spectral-order-distribution-b64-nonpermute-50000-iters'
eval_interval = 250
eval_iters = 200
log_interval = 10
...
wandb_run_name = 'seq256-online-spectral-order-distribution-b64-nonpermute-50000-iters'
