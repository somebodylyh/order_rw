# Continue from the same 5k checkpoint with a causal pairwise-precedence anchor.
# The online probe stays inside the training loop and runs every 20 steps.

out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-random-b64-head-signal-stable-try14-causal-precedence-anchor-5k-to5600'
eval_interval = 200
eval_iters = 100
log_interval = 20
...
wandb_run_name = 'seq256-random-b64-head-signal-stable-try14-causal-precedence-anchor-5k-to5600'
...
head_signal_probe_out_dir = 'Report/head_singal_Stable/try_14/online_training_probe'
...
head_signal_probe_position_anchor_source = 'target_precedence'
