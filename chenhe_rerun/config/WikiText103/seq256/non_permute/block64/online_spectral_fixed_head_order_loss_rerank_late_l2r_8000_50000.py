# WikiText103 seq256 non-permuted block64 config for fixed-head online
# attention-spectral order with current-frame loss reranking, followed by
# late curriculum annealing from the learned spectral order to L2R.
#
# Schedule:
#   0..8000: random fallback -> online spectral fixed-head loss-rerank
#   8000..50000: online spectral fixed-head loss-rerank -> L2R

out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-online-spectral-fixed-head-loss-rerank-late-l2r-8000-50000-b64-nonpermute-50000-iters'
eval_interval = 250
eval_iters = 200
log_interval = 10
...
wandb_run_name = 'seq256-online-spectral-fixed-head-loss-rerank-late-l2r-8000-50000-b64-nonpermute-50000-iters'
...
online_spectral_policy_late_l2r_anneal_enabled = True
...
# 16 x 64 = 1024 current-frame train probe samples for loss reranking.
