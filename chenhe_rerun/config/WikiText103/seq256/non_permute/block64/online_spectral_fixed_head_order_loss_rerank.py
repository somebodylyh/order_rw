...
# attention-spectral order with current-frame loss reranking.
#
...
out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-online-spectral-fixed-head-loss-rerank-b64-nonpermute-50000-iters'
eval_interval = 250
eval_iters = 200
log_interval = 10
...
wandb_run_name = 'seq256-online-spectral-fixed-head-loss-rerank-b64-nonpermute-50000-iters'
