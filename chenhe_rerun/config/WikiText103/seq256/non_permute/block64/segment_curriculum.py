...
# Usage:
#   python scripts/runner/hierarchical_segment_curriculum_runner.py config/WikiText103/seq256/non_permute/block64/segment_curriculum.py

config = 'config/WikiText103/seq256/non_permute/block64/random.py'

train_out_dir = 'out/curriculum/nonpermute/seq256/block64/out-wikitext103-seq256-random-b64-hcurr-margin-aligned-eval'
benchmark_root = 'Report/curriculum/nonpermute/seq256/block64/hierarchical_block64_margin_aligned_eval'

wandb_project = 'AOGPT-order-block-64'
wandb_run_name = 'seq256-random-b64-hcurr-margin'
