# Continue from the same 5k checkpoint with a model-internal position-anchor
# consensus rule and a larger in-loop attention probe sample budget.

out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-random-b64-head-signal-stable-try10-position-consensus-probe512-5k-to5600'
eval_interval = 200
eval_iters = 100
log_interval = 20
...
wandb_run_name = 'seq256-random-b64-head-signal-stable-try10-position-consensus-probe512-5k-to5600'
...
head_signal_probe_out_dir = 'Report/head_singal_Stable/try_10/online_training_probe'
