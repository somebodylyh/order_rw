# Continue the seq256/block64 non-permuted Random checkpoint while probing
# head-order orientation inside the training loop. The probe is diagnostic-only:
# it does not affect training orders, loss, optimizer state, or checkpoint
# selection.

out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-random-b64-head-signal-stable-try2-online-probe-5k-to5600'
eval_interval = 200
eval_iters = 100
log_interval = 20
...
wandb_run_name = 'seq256-random-b64-head-signal-stable-try2-online-probe-5k-to5600'
...
# Continuous in-loop head signal probe. This is intentionally frequent enough
# to catch sign oscillation during training instead of reconstructing it from
# sparse saved checkpoints.
head_signal_probe_enabled = True
head_signal_probe_interval = 20
head_signal_probe_out_dir = 'Report/head_singal_Stable/try_2/online_training_probe'
