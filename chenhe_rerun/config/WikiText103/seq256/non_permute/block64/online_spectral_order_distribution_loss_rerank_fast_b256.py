...
# - loss rerank:     8 x 256 = 2048 samples per candidate

_base_config = 'config/WikiText103/seq256/non_permute/block64/online_spectral_order_distribution_loss_rerank.py'
with open(_base_config, 'r', encoding='utf-8') as _handle:
    exec(_handle.read())

out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-online-spectral-order-distribution-loss-rerank-fast-b256-update5-no-random-mix-freeze40k-map-b64-nonpermute-50000-iters'
wandb_run_name = 'seq256-online-spectral-order-distribution-loss-rerank-fast-b256-update5-no-random-mix-freeze40k-map-b64-nonpermute-50000-iters'
compile = False
online_spectral_policy_update_every = 5
...
online_spectral_policy_loss_rerank_batches = 8
