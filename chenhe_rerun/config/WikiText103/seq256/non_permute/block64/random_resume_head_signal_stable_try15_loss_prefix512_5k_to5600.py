# Continue from the same 5k checkpoint with no position/original-direction anchor.
# Orientation uses only current-model raw-vs-reverse prefix conditional loss
# plus same-step loss-weighted cross-head consensus.

out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-random-b64-head-signal-stable-try15-loss-prefix512-5k-to5600'
eval_interval = 200
eval_iters = 100
log_interval = 20
...
wandb_run_name = 'seq256-random-b64-head-signal-stable-try15-loss-prefix512-5k-to5600'
