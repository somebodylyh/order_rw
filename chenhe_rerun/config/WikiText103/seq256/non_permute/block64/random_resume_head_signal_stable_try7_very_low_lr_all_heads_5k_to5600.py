# Continue from the same 5k checkpoint with a 100x lower LR while probing all
# heads. This tests whether a two-timescale update regime can keep head order
# orientation stable during online training.

out_dir = 'out/base/nonpermute/seq256/block64/out-wikitext103-seq256-random-b64-head-signal-stable-try7-very-low-lr-all-heads-5k-to5600'
eval_interval = 200
eval_iters = 100
log_interval = 20
...
wandb_run_name = 'seq256-random-b64-head-signal-stable-try7-very-low-lr-all-heads-5k-to5600'
...
head_signal_probe_out_dir = 'Report/head_singal_Stable/try_7/online_training_probe'
