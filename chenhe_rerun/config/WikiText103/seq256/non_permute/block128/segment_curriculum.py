...
# Usage:
#   python scripts/runner/hierarchical_segment_curriculum_runner.py config/WikiText103/seq256/non_permute/block128/segment_curriculum.py

config = 'config/WikiText103/seq256/non_permute/block128/random.py'

train_out_dir = 'out/curriculum/nonpermute/seq256/block128/out-wikitext103-seq256-random-b128-hcurr-margin-aligned-eval'
benchmark_root = 'Report/curriculum/nonpermute/seq256/block128/hierarchical_block128_margin_aligned_eval'

wandb_project = 'AOGPT-order-block-128'
wandb_run_name = 'seq256-random-b128-hcurr-margin'
