...
# Usage:
#   python scripts/runner/hierarchical_segment_curriculum_runner.py config/WikiText103/seq256/non_permute/block32/segment_curriculum.py

config = 'config/WikiText103/seq256/non_permute/block32/random.py'

train_out_dir = 'out/curriculum/nonpermute/seq256/block32/out-wikitext103-seq256-random-b32-hcurr-margin-aligned-eval'
benchmark_root = 'Report/curriculum/nonpermute/seq256/block32/hierarchical_block32_margin_aligned_eval'

wandb_project = 'AOGPT-order-block-32'
wandb_run_name = 'seq256-random-b32-hcurr-margin-对齐loss'
