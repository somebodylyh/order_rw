...
OUT_ROOT=$ROOT/probe_results_image_large/grw_e3ctrlsmall_round2_seed123_minimal
...
MASTER_LOG=$OUT_ROOT/seed123_master.log
SEED=123

mkdir -p "$OUT_ROOT"
{
  echo "Round-2 seed=123 minimal replication"
  date -Is
...
echo "seed=123 minimal finished $(date -Is)" | tee -a "$MASTER_LOG"
